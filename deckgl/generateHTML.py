...
view_state = pdk.ViewState(
    longitude=8.200262, latitude=48.105194, zoom=14, min_zoom=1, max_zoom=20, pitch=40, bearing=-30,
)
# Render
r = pdk.Deck(layers=[layer], initial_view_state=view_state,
             mapbox_key="pk.eyJ1IjoiYXJjYXhjIiwiYSI6ImNrYjd4bmNoNjBhYTEyd3FocTBnYzFoZ24ifQ.i2OEIQFKyieMxuUhq-s9Xw", )
